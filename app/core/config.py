...
# #from pydantic import , BaseSettings # AnyHttpUrl é um tipo de dado do Pydatic que valida se uma string é uma URL HTTP/HTTPS válidas. BaseSettings é uma classe do pydantic usada para criar classes de configuração que automaticamente leem valores do ambiente,.env
...
from pydantic_settings import BaseSettings
from decouple import config  # ou use os.environ.get se não usar python-decouple
